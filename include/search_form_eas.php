<a href="http://www4.wittenberg.edu/academics/east/Journal/journal.htm"><img src="http://www.wittenberg.edu/sites/default/files/images/easjournal.gif" height=100 border=0 align=right></a>
         <h2>
         Index to <cite>Wittenberg University East Asian Studies Journal</cite>, 1976-<?=$end_date?> </h2>
...
<?php
                 /*
print "<strong> or Browse by: </strong> <a href=\"$this_file?browse=author\">Author</a> | <a href=\"$this_file?browse=title\">Title</a> | <a href=\"$this_file?browse=genre\">Genre</a> | <a href=\"$this_file?browse=year\">Year</a>";
*/
?>
